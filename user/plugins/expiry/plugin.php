...
echo <<<HTML
	<link rel="stylesheet" href="/css/infos.css?v={$yourls_version}" type="text/css" media="screen">
	<script src="/js/infos.js?v={$yourls_version}" type="text/javascript"></script>
	<div id="wrap">
		<div id="tabs">
...
echo <<<HTML
			...
			<div  id="stat_tab_api" class="tab">
				...
				<div style="padding-left: 10pt;border-left:1px solid blue;border-bottom:1px solid blue;">
					...
					<p>These actions require authentication. Along with auth data, send one of the following:</p>
